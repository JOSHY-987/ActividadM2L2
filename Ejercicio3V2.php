            ...
            <div class="col-sm-6 p-5 bg-white shadow-lg rounded">
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label for="texto2">Texto Aqui</label>
                        <input id="texto2" class="form-control" type="text" name="texto2">
                    </div>

                    <br>

                    <div class="row justify-content-center">
                        <button class="btn btn-primary" id="mostrarej3v2" type="button">Mostrar Resultado</button>
                    </div>
